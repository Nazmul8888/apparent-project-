    ...
    return (
        <div className="py-10">
            <h2 className="text-3xl text-center">
                <span className=" text-pink-400">Welcome Back</span>
                {
            ...
            <div className="stats shadow">
                ...
                <div className="stat">
                    ...
                    <div className="stat-value">{stats.apartmentItems}</div>
                ...
                <div className="stat">
                    ...
                    <div className="stat-title"> Apartment</div>
                    <div className="stat-value">{stats.apartmentItems}</div>
                    <div className="stat-desc">↗︎ 400 (22%)</div>
                </div>
